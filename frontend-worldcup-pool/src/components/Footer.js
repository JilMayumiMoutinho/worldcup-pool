...
import CopyIcon from "../assets/CopyIconW.png";
import { ContainerFooter, FooterSection, ContainIcons, Copy, CRStyles } from "./styles";
    ...
    <>
      ...
      <Copy>
        ...
        <CRStyles
          src={CopyIcon}
          alt={
            " Copy right icon - https://icons8.com/icon/7764/direitos-autorais"
          }
        />
      </Copy>
    </>
